...
#include "impeller/entity/uber_sdf_instanced_fastpath.frag.h"
#include "impeller/entity/uber_sdf_instanced_fastpath.vert.h"
...
using InstancedUberSDFFastpathPipeline = RenderPipelineHandle<UberSdfInstancedFastpathVertexShader, UberSdfInstancedFastpathFragmentShader>;
